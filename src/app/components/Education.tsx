  ...
  return (
    <section id="education">
      <div className="px-4 sm:px-6">
        ...
        <div className="bg-gray-50 border-l-4 border-gray-600 rounded-lg shadow-sm hover:bg-gray-100 overflow-hidden">
          ...
          <div className="px-5 sm:px-6 pt-5 sm:pt-6 pb-3">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-baseline gap-1 sm:gap-2">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-700 leading-tight">
          ...
          <div className="px-5 sm:px-6 pb-5 sm:pb-6 space-y-3">
            ...
            <div className="flex flex-col sm:flex-row justify-between pt-2 border-t border-gray-200">
              <div>
                ...
                <h4 className="text-sm sm:text-base text-gray-500 mt-1">
                  Focus in Fluid and Thermal Sciences
                </h4>
              </div>
              <div className="text-sm sm:text-base text-gray-500 mt-2 sm:mt-0 sm:pl-4 whitespace-nowrap">
                Aug 2023 - May 2026
              </div>
            </div>
