  ...
  return (
    <section id="contactme">
      <div className="mx-auto mt-8 m-3">
        <h1 className="text-3xl font-bold mt-8 m-3 text-[#041725]">
          Contact Me
        </h1>
        <div className="flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8">
          <div className="w-full max-w-md">
            <div className="bg-white border-t-4 border-[#041725] rounded-lg shadow-lg p-6">
              {isSubmitted ? (
                ...
                >
                  ...
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-sm font-medium text-[#041725] mb-1"
                    >
                      Name
                    </label>
                    <input
                  ...
                  <div>
                    <label
                      htmlFor="email"
                      className="block text-sm font-medium text-[#041725]0 mb-1"
                    >
                      Email
                    </label>
                    <input
